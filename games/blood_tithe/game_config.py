"""Blood Tithe v9 — 6x6 cluster cascade, base game as primary RTP delivery.
...
class GameConfig(Config):
    """Singleton Blood Tithe configuration."""
    ...
    def __init__(self):
        super().__init__()
        self.game_id = "blood_tithe"
        self.provider_number = 0
        self.working_name = "Blood Tithe"
        self.wincap = 8000.0
        ...
        pay_group = {
            ...
            # v13: All L values rounded to 0.10 multiples for StakeEngine compliance
            (t1, "L1"): 0.10,
            (t2, "L1"): 0.10,
            (t3, "L1"): 0.30,
            (t4, "L1"): 1.00,
        ...
        self.special_symbols = {"scatter": ["SC"], "retrigger": ["PT"], "wild": ["WI"]}
        ...
        self.gauge_fill_per_l_symbol_base = 3.0  # Base game: 3.0% per L (reduced from 4.0 — persisting wilds snowball L clusters, accelerating fill)
        ...
        self.regular_symbols = ["H1", "H2", "H3", "H4", "L1", "L2", "L3", "L4", "WI"]
